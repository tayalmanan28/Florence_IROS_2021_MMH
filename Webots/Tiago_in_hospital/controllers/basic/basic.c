...
int main(int argc, char **argv) {
  ...
  const char *names[N_PARTS] = {"head_2_joint",      "head_1_joint",      "torso_lift_joint",  "arm_right_1_joint",
                                 ...
                                 "arm_left_1_joint", 
                                "arm_left_3_joint",  "arm_left_4_joint",    "wheel_left_joint",  "wheel_right_joint"};

  double target_pos[N_PARTS] = {0.24, -0.67, 0.09, 0.7, 1.6, 1.5,     
                                0.7,  1.6, 1.5,  INFINITY, INFINITY};
  ...
  //wb_motor_set_velocity(robot_parts[N_PARTS-2], wb_motor_get_max_velocity(robot_parts[N_PARTS-2]) / 2.0);
  //wb_motor_set_velocity(robot_parts[N_PARTS-1], wb_motor_get_max_velocity(robot_parts[N_PARTS-1]) / 2.0);
